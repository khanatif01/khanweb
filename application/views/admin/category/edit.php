<?php $this->load->view('admin/header'); ?>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url().'admin/home'; ?>">Categories</a></li>
              <li class="breadcrumb-item active">Edit Categories/"<?php echo $category['id'] ?>"</li>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            Edit Category "<?php echo $category['name'] ?>"   
             ...
             action="<?php echo base_url().'admin/category/edit/'.$category['id']; ?>">
       <div class="card-body">
        ...
        <?php  }  else { ?>
     <img class="mt-3" src="<?php echo base_url().'public/uploads/category/noimage.png'; ?>">
        <?php  } ?>
            </div>
    ...
    <button type="submit" name="submit" class="btn btn-primary ml-2 mb-2">Update</button>
    <a href="<?php echo base_url().'admin/category/index'; ?>" class="btn btn-secondary mb-2 ml-2">Back</a>
  ...
  <!-- /.content-wrapper -->
  <!-- <img class="mt-3" src="http://localhost/haseebwebapp/public/uploads/category/no-image.jpg"> -->
  <!-- <img class="mt-3" src="http://localhost/haseebwebapp/public/uploads/category/thumb/ec71c43bb6c8b762c21144ad1c90335f.jpg"> -->
